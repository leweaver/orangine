...
struct Manager_instances {
  ...
  using Managers_tuple = std::tuple<
          Manager_instance<IAnimation_manager>,
          Manager_instance<IAsset_manager>,
          Manager_instance<IBehavior_manager>,
          Manager_instance<IScene_graph_manager>,
          Manager_instance<ITime_step_manager>>;
