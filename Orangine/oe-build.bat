...
if NOT "!OE_BUILD_CONFIG!" EQU "" (
    set OE_BUILD_DIR=%OE_ROOT%\cmake-ninjabuild-%CM_ARCHITECTURE%-!OE_BUILD_CONFIG!
...
set OE_BUILD_DIR=%OE_ROOT%\cmake-ninjabuild-%CM_ARCHITECTURE%-!OE_CONFIGURE_BUILD_CONFIG!
IF NOT EXIST "!OE_BUILD_DIR!" md !OE_BUILD_DIR!
cd !OE_BUILD_DIR!
"%OE_CMAKE_EXE%" -G "Ninja" -DCMAKE_CXX_COMPILER:FILEPATH="%VCToolsInstallDir%bin\Host%CM_ARCHITECTURE%\%CM_ARCHITECTURE%\cl.exe" -DCMAKE_MAKE_PROGRAM="%OE_NINJA_EXE%" -DCMAKE_DEBUG_POSTFIX=_d -DCMAKE_INSTALL_PREFIX:PATH="%OE_ROOT%\..\bin\%CM_ARCHITECTURE%\!OE_CONFIGURE_BUILD_CONFIG!" -DCMAKE_BUILD_TYPE="!OE_CONFIGURE_BUILD_CONFIG!" "%OE_ROOT%"

set OE_CONFIGURE_BUILD_CONFIG=RelWithDebInfo
set OE_BUILD_DIR=%OE_ROOT%\cmake-ninjabuild-%CM_ARCHITECTURE%-!OE_CONFIGURE_BUILD_CONFIG!
IF NOT EXIST "!OE_BUILD_DIR!" md !OE_BUILD_DIR!
cd !OE_BUILD_DIR!
"%OE_CMAKE_EXE%" -G "Ninja" -DCMAKE_CXX_COMPILER:FILEPATH="%VCToolsInstallDir%bin\Host%CM_ARCHITECTURE%\%CM_ARCHITECTURE%\cl.exe" -DCMAKE_MAKE_PROGRAM="%OE_NINJA_EXE%" -DCMAKE_INSTALL_PREFIX:PATH="%OE_ROOT%\..\bin\%CM_ARCHITECTURE%\!OE_CONFIGURE_BUILD_CONFIG!" -DCMAKE_BUILD_TYPE="!OE_CONFIGURE_BUILD_CONFIG!" "%OE_ROOT%"
