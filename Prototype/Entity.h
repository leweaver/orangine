...
namespace oe {
	...
	private:
		...
		typedef std::vector<std::shared_ptr<Entity>> Entity_ptr_vec;
		typedef std::map<Id_type, std::shared_ptr<Entity>> Entity_ptr_map;
