...
namespace OE {
	...
	public:
		...
		std::vector<std::shared_ptr<Entity>> LoadFile(const std::string &path, EntityRepository &entityFactor, MaterialRepository &materialRepository, PrimitiveMeshDataFactory &meshDataFactory) const override;
	};
